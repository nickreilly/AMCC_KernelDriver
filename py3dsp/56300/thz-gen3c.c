...
/*
   ...
   the CDS pair AFTER the reset.  This clock also has the ability to output
   just the Ped frame and NOT do shutter or Sig.  
...
int gb_sutr = 0;
int gb_onepix = 0;
int gb_pedonly = 1;  /* toggle PED or PEDSIG mode: 0=PEDSIG 1=PED */
...
{
	  __asm("\n\
	  movep   #(DetOff),Y:DetPort ; send PhiS[1,2] low=off \n\
          ; remove the read enable        \n\
	  nop              \n\
	  ");
